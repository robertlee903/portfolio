...
describe('application tests', () => {
  ...
  it('should render name: Zhao Lee', () => {
    const element = screen.getByTestId('name');

    checkContent(element, /^Zhao Lee$/);
  });
  ...
  it('should render creator', () => {
    ...
    checkContent(element, /^Zhao Lee$/, 'https://zhaolee97.netlify.app');
  });

  it('should render link to source code', () => {
    const element = screen.getByTestId('source');

    checkContent(element, /^Source$/, 'https://github.com/robertlee903/portfolio');
  });
  ...
  it('should render GitHub button', () => {
    ...
    checkButton(parent, child, /^GitHub$/, 'https://github.com/robertlee903/');
  });
  ...
  it('should render full footer on desktop', () => {
    ...
    expect(footer).toHaveTextContent(
      /^Designed and built by Zhao Lee \| Source$/
    );
  });
});
...
describe('app context tests', () => {
  it('should render partial footer on mobile', () => {
    ...
    expect(footer).toHaveTextContent(/^Designed and built by Zhao Lee$/);
